...
describe ImageIndexer do
  ...
  context 'with a generic_file' do
    ...
    it 'has images' do
      expect(subject['thumbnail_url_ssm']).to eq ['http://localhost:3000/images/bf%2F74%2F27%2F75%2Fbf742775-2a24-46dc-889e-cca03b27b5f3%2Foriginal/full/300,/0/default.jpg']
      expect(subject['image_url_ssm']).to eq ['http://localhost:3000/images/bf%2F74%2F27%2F75%2Fbf742775-2a24-46dc-889e-cca03b27b5f3%2Foriginal/full/600,/0/default.jpg']
      expect(subject['large_image_url_ssm']).to eq ['http://localhost:3000/images/bf%2F74%2F27%2F75%2Fbf742775-2a24-46dc-889e-cca03b27b5f3%2Foriginal/full/1000,/0/default.jpg']
    end
  end
